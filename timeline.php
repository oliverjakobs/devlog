...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-content container clearfix">
      ...
      <div class="block">
        <h1 class="title separator-bottom">Timeline</h1>
        ...
        <article class="post">
          ...
          <div>
            <p class="summary justify">
              Nullam efficitur in mi pharetra bibendum. Nunc justo metus, hendrerit id vehicula vel, feugiat ut eros. Mauris condimentum laoreet sem quis malesuada. 
